      ...
      <div class="content-wrapper">
		...
		<section class="content-header">
				<br><ol class="breadcrumb">
					...
					<li class="active">Bulk Upload Employee</li>
				</ol>			
			</section>
				<br>
		<div class="main-content">
			<div class="panel panel-primary">
				...
				<form id="uploadEmployees" action="uploadEmployee.action?method:uploadEmployee" method="post" enctype="multipart/form-data">
					...
					<input type="file" name="fileupload" value="fileupload" id="fileupload" Class="btn btn-primary center-block">
						<table class="center-block" >
								...
								<tr><a href="../../apps/files/employee_upload.csv" download>Click here to download a CSV Template</a></tr>
								<br>
								<tr><a href = "../../apps/files/error_log.txt" download> Click here to view the Error Log File</a></tr>
